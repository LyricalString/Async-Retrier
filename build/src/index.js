...
*/
var asyncRetry = function (fn, options) {
    if (options === void 0) { options = {}; }
    return __awaiter(void 0, void 0, void 0, function () {
        var retries, maxRetries, delay, onError, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    onError(e_1, retries, delay);
                    return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, delay); })];
                case 5:
                    _a.sent();
                    return [3 /*break*/, 6];
                case 6: return [3 /*break*/, 1];
                case 7: throw new Error("Unable to complete function after ".concat(maxRetries, " retries"));
            }
        });
    });
};
